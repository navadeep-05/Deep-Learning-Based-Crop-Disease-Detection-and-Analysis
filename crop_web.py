...
def model_prediction(test_image):
    model = tf.keras.models.load_model(r"C:\Users\WINDOWS 10\OneDrive\Documents\Plant Diseases Dataset(Project)\New Plant Diseases Dataset\crop_disease_model.keras")
